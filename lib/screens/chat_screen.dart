    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot){
        ...
        for (var message in messages){
          ...
          final messageBubble = MessageBubble(messageText: messageText, messageSender: messageSender,isMe: currentUser == messageSender,);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(messageSender,style: const TextStyle(fontSize: 10,color: Colors.black26),),
          Material(
            elevation: 15,
            ...
            child:Padding(
              ...
              child: Text(messageText,style: isMe?TextStyle(color: Colors.white):TextStyle(color: Colors.grey.shade700),),
            )
          ),
        ],
      ),
